...
installLibrary flux-authentication-backend-api https://github.com/fluxfw/flux-authentication-backend-api/archive/refs/tags/v2023-03-02-1.tar.gz

installLibrary flux-config-api https://github.com/fluxfw/flux-config-api/archive/refs/tags/v2023-02-27-1.tar.gz

installLibrary flux-http-api https://github.com/fluxfw/flux-http-api/archive/refs/tags/v2023-03-02-1.tar.gz
